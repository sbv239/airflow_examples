...
with DAG(
    ...
    for i in range(10):
        ...
        task_bash = BashOperator(
            task_id='task_bash_' + str(i),  # в id можно делать все, что разрешают строки в python
            bash_command='echo {i}'
        )
    ...
    for i in range(20):
        ...
        task_python = PythonOperator(
            task_id='task_python_' + str(i),  # в id можно делать все, что разрешают строки в python
